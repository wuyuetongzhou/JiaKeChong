(function () {
    tinymce.create("tinymce.plugins.ImageUploadPlugin", {
        init: function (e, t) {
            ...
            e.addButton("imageupload", {title: "上传图片", cmd: "mceImageUpload", image: t + "/img/icon.png"})
        }, getInfo: function () {
            return {
